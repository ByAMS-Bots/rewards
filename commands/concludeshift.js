...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('conclude-shift')
        .setDescription('Send the shift concluded message.'),
    async execute(interaction) {
        try {
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription(serverSettings.shiftEndMessage)
            ...
            console.error('Error sending shift concluded message:', error);
