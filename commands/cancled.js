...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('cancel')
        .setDescription('Send the canceled message.'),
    async execute(interaction) {
        try {
            ...
            const embed = new MessageEmbed()
                ...
                .setDescription(serverSettings.cancelMessage)
                .setFooter(serverSettings.Branding)
                .addFields(
                    { name: 'Status', value: 'Cancled' },
                );
            ...
            console.error('Error sending training cancled message:', error);
            await interaction.reply('Error sending cancled message. Please try again later.');
        }
    },
};
